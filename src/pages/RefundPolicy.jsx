...
function RefundPolicy() {
  return (
    <div className="max-w-5xl mx-auto p-6 flex flex-col text-white">
      ...
      <p>Thank you for shopping at Effeg website and Gaming Heatmap app.</p>
      <p>
      ...
      <ul>
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named Gaming
            Heatmap
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Effeg.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        reimbursement. However do note that the reimbursement may be delayed.
      </p>
