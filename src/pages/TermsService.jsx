...
function TermsService() {
  return (
    <div className="max-w-5xl mx-auto p-6 flex flex-col text-white">
      ...
      <p>
        This website is operated by Effeg. Throughout the site, the terms “we”,
        “us” and “our” refer to Effeg. Effeg offers this website, including all
      ...
      <p>
        ...
        durability, title, and non-infringement. In no case shall Effeg, our
      ...
      <p>
        You agree to indemnify, defend and hold harmless Effeg and our parent,
      ...
      <div className="flex flex-col">
        Our contact information is posted below: Effeg28@gmail.com UEN:
        53459696K
      </div>
    </div>
  );
